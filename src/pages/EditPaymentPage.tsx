    ...
    <Layout>
      ...
      <Layout.Content>
        <Row justify='center' align='middle'>
          <Card title='Змінити реквізити' style={{ width: '90%', margin: SIZES.margin }}>
            <List bordered>
              <List.Item>
                <Col span={24}>
              ...
              <List.Item>
                <Col span={24}>
                  <Typography.Text>Код отримувача (код за ЄДРПОУ)</Typography.Text>
                  <Input
              ...
              <List.Item>
                <Col span={24}>
                  <Typography.Text>Призначення платежу</Typography.Text>
                  <Input
              ...
              <List.Item>
                <Upload name='logo' action='/upload.do' listType='picture'>
                  <Button icon={<UploadOutlined />}>Загрузити квитанцію</Button>
                </Upload>
              </List.Item>
